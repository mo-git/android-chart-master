...
package com.android.chart.renderer;
...
import com.android.chart.interfaces.datasets.IPieDataSet;
...
//        mValuePaint.setTextAlign(Align.CENTER);
    ...
    protected float calculateMinimumRadiusForSpacedSlice( PointF center, float radius, float angle, float arcStartPointX,
        ...
        spacedRadius -= Math.sqrt(  Math.pow(arcMidPointX - (arcEndPointX + arcStartPointX) / 2.f, 2) +
